...
def classify_integrated_references(
    ...
    if test_ptr.nrow() != len(integrated_prebuilt.test_features):
        raise ValueError("number of rows in 'test_data' should equal number of features in 'integrated_prebuilt'")
    nc = test_ptr.ncol()
    ...
    for i, r in enumerate(all_refs):
        ...
        if len(curlabs) != nc:
            raise ValueError("each entry of 'results' should have results for all cells in 'test_data'")
