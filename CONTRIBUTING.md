...
Welcome to `singler` contributor's guide.
...
If you experience bugs or general issues with `singler`, please have a look
...
You can help improve `singler` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`singler` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `singler`'s files. While this mechanism can
...
```
conda create -n singler python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/singler.git
   cd singler
   ```
...
5. Install [pre-commit]:
   ...
   `singler` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/singler
[issue tracker]: https://github.com/<USERNAME>/singler/issues
